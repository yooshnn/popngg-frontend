...
function useFooterGroups(): FooterGroup[] {
  ...
  return [
    ...
    },
    {
      ...
      links: [
        { label: t('footer.groups.link.register'), to: '/renew' },
...
function FooterNotice() {
  ...
  return (
    <div className="mt-12 grid gap-5 border-t border-stroke-neutral-weak pt-6 text-sm leading-[1.7] text-fg-neutral-muted md:grid-cols-[180px_minmax(0,1fr)] md:gap-x-8">
      ...
      <div>
        <p className="max-w-[720px]">{KONAMI_NOTICE}</p>
...
export function AppFooter() {
  return (
    <footer className="mt-auto w-full border-t border-stroke-neutral-weak bg-[linear-gradient(to_bottom,var(--color-bg-neutral-weak)_33%,var(--color-bg-layer-default)_100%)]">
