...
export type CheckboxProps
  = Omit<CheckboxPrimitive.Root.Props, 'children' | 'className' | 'render' | 'style'>
    & {
      children: ReactNode;
      /** Replaces `children` for assistive tech when the visible text is abbreviated. */
      accessibleLabel?: string;
      /** Any CSS color. Domain palettes such as chart difficulty pass their own hex here. */
      checkedColor?: string;
      className?: string;
    };
